                                ...
                                <div class="tab-content mt-4">
                                    <div class="tab-pane fade active show" id="general">
                                        <div class="form-group">
                                            <label for="sel1">Select Post Category:</label>
                                            <select class="form-control" id="sel1" name="postcategory">
                                                @if($p_cat))
                                                @foreach($p_cat as $p)
                                                @if(isset($s_cat))
                                                <option value="{{$p->id}}" {{($p->id == $s_cat->id)? "selected" : '';}}>
                                                    {{$p->name}}</option>
                                                @else
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-8">
                                                ...
                                                <img src="{{asset('admin/post')}}/{{$post->featured_image}}" alt=""
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{isset($post->btn_name)? $post->btn_name: old('btn_name') }}"
                                                    placeholder="Enter button name" name="btn_name">
                                                <span class="text-danger">
                                                    @error('btn_name')
                                                    {{$message}}
                                                    @enderror
                                            ...
                                            @if(isset($post->postcategory))
                                             @if($post->postcategory == '1')
                                                    <div class="form-group col-md-6">
                                                        <label>Price</label>
                                                        <input type="text" class="form-control"
                                                            value="{{isset($post->price)? $post->price: old('btn_link') }}"
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{isset($post->btn_link)? $post->btn_link: old('btn_link') }}"
                                                    placeholder="copy button link" name="btn_link">
                                                <span class="text-danger">
                                                    @error('btn_name')
                                                    {{$message}}
                                                    @enderror
