        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                <div class="col-md-12">
                  <p class="mb-0"> <strong>Order ID:</strong>  #{{$data->id}} &nbsp;&nbsp;&nbsp; <strong> Date:</strong> {{$date}}</p>
                </div>
              </div><hr>
              ...
              <div class="row no-print">
                ...
                <div class="col-12">
                  ...
                  <a href="{{route('print-single-order', $data->id)}}" rel="noopener" target="_blank" class="btn btn-primary float-right"><i class="fas fa-download"></i> Generate PDF</a>
