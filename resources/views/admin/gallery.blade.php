...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
                        ...
                        <div class="card-body">
                            <div class="form-group dropzone-div">
                                ...
                                <div class="clsbox-1" runat="server">
                                    <div class="dropzone clsbox" action="{{ route('savegallery') }}" id="mydropzone">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">Gallery</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 position-relative gallery-img-box">
                                <a href="{{route('gallerydelete', $i->id)}}">
                                <img src="{{asset('admin/gallery')}}/{{$i->image}}" alt="" class="w-100 gallery-img">
