              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  @foreach ($data as $post)
                    ...
                    <td>{{$post->title}}</td>
                    <td><img src="{{asset('uploads/banners/').'/'.$post->image}}" alt="" class="img-fluid" width="100px" height="100px"></td>
                    <td><a href="{{route('banners.edit', $post->id)}}" class="btn btn-primary">Edit</a>
                ...
                <div class="modal fade" id="myModal">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <form  method="post" action="{{route('banners.delete')}}">
                        @csrf
