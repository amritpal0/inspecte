              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <td><img src="{{asset('admin/testimonials')}}/{{$post->featured_image}}" alt="" class="img-fluid" width="100px" height="100px"></td>
                    <td><a href="{{route('testimonial.edit', $post->id)}}" class="btn btn-primary">Edit</a>
