...
<profile_section>
<h2>COMMERCIAL ACCOUNT MANAGER'S PROFILE</h2>
...
<input class="btn_profile owner_register" type="button" id="contact_form" value="Save Now" />
...
<script>
    ...
    $('.owner_register').on('click', function(){
        $('.register_msg').empty();
